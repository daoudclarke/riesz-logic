...
\documentclass[journal,draftcls,onecolumn,letterpaper,12pt]{IEEEtran}
%% \documentclass[preprint,leqno]{elsarticle}

%\documentclass{article}

\author{Daoud Clarke
\thanks{Daoud Clarke is with the University of Sussex.}}
\date{\today}
\title{Riesz Logic}
...
\includegraphics{riesz-logic-pics.pdf}
