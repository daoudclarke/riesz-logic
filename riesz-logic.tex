...
``distributional entailment''. Several axioms of RL are familiar from
Basic Fuzzy Logic, and we show how the models of these two logics may
be related; RL may thus be considered a new class of fuzzy logic.
\end{abstract}
